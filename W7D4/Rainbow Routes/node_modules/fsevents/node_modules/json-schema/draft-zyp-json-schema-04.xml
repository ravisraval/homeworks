			...
			<section title="links" anchor="links">
				...
				<section title="Link Description Object">
					<t>
						...
						<eref target="http://json-schema.org/NavLinks">http://json-schema.org/NavLinks</eref> (latest version) or
						<eref target="http://json-schema.org/draft-04/NavLinks">http://json-schema.org/draft-04/NavLinks</eref> (draft-04 version).
					</t>
