...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity"
      expect { Desser.new("pie", "a lot", chef) }.to raise_error(ArgumentError)
    end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ...
      expect(brownie.ingredient).to_eq(ingredients)
      brownie.mix!
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name"
      ...
      expect(brownie.serve).to eq("Chef Bobby the Great")
  end
